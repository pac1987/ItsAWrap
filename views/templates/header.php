<html>
    ...
    <head>
        ...
        <title>ItsAWrap</title>

        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="<?php echo base_url("asset/css/bootstrap.min.css"); ?>" rel="stylesheet">
        <script src="<?php echo base_url("asset/js/jquery.js"); ?>"></script>
        <script src="<?php echo base_url("asset/js/scripts.js"); ?>"></script>
        <!-- Custom CSS -->
        <link href="<?php echo base_url("asses/css/sb-admin.css"); ?>" rel="stylesheet">
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
        ...
        <div class="container-fluid" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-light" href="" style="color: #f3f3f3"><strong>ItsAWrap</strong></a>
            </div>
